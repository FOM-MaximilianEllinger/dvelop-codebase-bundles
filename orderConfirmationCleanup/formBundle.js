...
/***/ "../../helper/classconorderconfirmations/ReClassifyItem.ts"
/*!*****************************************************************!*\
  !*** ../../helper/classconorderconfirmations/ReClassifyItem.ts ***!
  \*****************************************************************/
...
exports.reClassifyItem = reClassifyItem;
...
async function reClassifyItem(baseUri, params, token) {
    const url = `${baseUri}/classconorderconfirmations/DocumentProcessing/ReClassifyItem`;
...
/***/ "../../helper/classconorderconfirmations/deleteOrderConfirmationBadge.ts"
/*!*******************************************************************************!*\
  !*** ../../helper/classconorderconfirmations/deleteOrderConfirmationBadge.ts ***!
  \*******************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.deleteOrderConfirmationBadge = deleteOrderConfirmationBadge;
const performHttpRequest_1 = __webpack_require__(/*! ../performHttpRequest/performHttpRequest */ "../../helper/performHttpRequest/performHttpRequest.ts");
/**
 * Deletes an order confirmation badge for a given subscription and task.
 *
 * Sends a POST request to the DocumentProcessing/DeleteItem endpoint to remove the badge
 * associated with the specified subscription and task.
 *
 * @param baseUri - The base URI of the API endpoint.
 * @param token - The bearer token for authentication.
 * @param subscriptionId - The ID of the subscription.
 * @param taskId - The ID of the task for which the badge should be deleted.
 * @returns A promise resolving to an ApiResponse containing the result of the delete operation.
 */
async function deleteOrderConfirmationBadge(baseUri, token, subscriptionId, taskId) {
    const url = `${baseUri}/classconorderconfirmations/DocumentProcessing/DeleteItem`;
    const headers = {
        ...(token ? { "Authorization": `Bearer ${token}` } : {}),
        "Accept": "*/*",
    ...
    const body = new URLSearchParams({
        ...
        processSequenceID: "drOrderconfirmation",
        taskID: taskId,
    }).toString();
    const options = {
        method: "POST",
...
/***/ "../../helper/classconorderconfirmations/getFeatures.ts"
/*!**************************************************************!*\
  !*** ../../helper/classconorderconfirmations/getFeatures.ts ***!
  \**************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
const performHttpRequest_1 = __webpack_require__(/*! ../performHttpRequest/performHttpRequest */ "../../helper/performHttpRequest/performHttpRequest.ts");
async function getFeatures(baseUri, token) {
    const url = `${baseUri}/classconorderconfirmations/getFeatures`;
    const headers = {
        ...(token ? { "Authorization": `Bearer ${token}` } : {}),
...
/***/ "../../helper/classconorderconfirmations/getOrderConfirmationBadges.ts"
/*!*****************************************************************************!*\
  !*** ../../helper/classconorderconfirmations/getOrderConfirmationBadges.ts ***!
  \*****************************************************************************/
(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.getOrderConfirmationBadges = getOrderConfirmationBadges;
const performHttpRequest_1 = __webpack_require__(/*! ../performHttpRequest/performHttpRequest */ "../../helper/performHttpRequest/performHttpRequest.ts");
/**
 * Retrieves order confirmation badges for a given repository.
 *
 * Sends a GET request to the DocumentProcessing endpoint to fetch batch tasks related to order confirmations.
 *
 ...
 */
async function getOrderConfirmationBadges(baseUri, token, subscriptionId) {
    const url = `${baseUri}/classconorderconfirmations/DocumentProcessing/GetBatchTasksNew?id=${subscriptionId}`;
    const headers = {
        ...(token ? { "Authorization": `Bearer ${token}` } : {}),
        "Accept": "application/json",
        "Content-Type": "application/json",
...
const getFeatures_1 = __webpack_require__(/*! ../../../../helper/classconorderconfirmations/getFeatures */ "../../helper/classconorderconfirmations/getFeatures.ts");
const getOrderConfirmationBadges_1 = __webpack_require__(/*! ../../../../helper/classconorderconfirmations/getOrderConfirmationBadges */ "../../helper/classconorderconfirmations/getOrderConfirmationBadges.ts");
const deleteOrderConfirmationBadge_1 = __webpack_require__(/*! ../../../../helper/classconorderconfirmations/deleteOrderConfirmationBadge */ "../../helper/classconorderconfirmations/deleteOrderConfirmationBadge.ts");
const ReClassifyItem_1 = __webpack_require__(/*! ../../../../helper/classconorderconfirmations/ReClassifyItem */ "../../helper/classconorderconfirmations/ReClassifyItem.ts");
...
/**
 * Bereinigung Auftragsbestätigungsleser (ehemals
 * projects/deleteBadgesFromDocumentReaderForm): listet die Stapel des
 * Auftragsbestätigungslesers (classconorderconfirmations), filterbar nach
 * Name und Erstellungsdatum, und löscht bzw. klassifiziert markierte Stapel
 * erneut - komplett im Browser über die Session des angemeldeten Benutzers.
 * Die Oberfläche teilt sich dieses Werkzeug mit der "Bereinigung
 * Rechnungsleser" (helper/dforms/classconBatchCleanup.ts), hier stehen nur
 * die App-spezifischen Aufrufe.
 *
 ...
 * Das bereits bestehende Formular behält seine GUID (PINNED_FORM_IDS in
 * projects/Toolbox/generateTargetForms.js).
 *
...
window.formInit = function (form, data) {
    logger.debug("Bereinigung-Auftragsbestätigungsleser-Formular initialisiert.");
    (0, classconBatchCleanup_1.initClassconBatchCleanup)(form, {
        title: "Stapel im Auftragsbestätigungsleser",
        appName: "Auftragsbestätigungsleser",
        findSubscriptionId: async () => {
            const features = await (0, getFeatures_1.getFeatures)(BASE_URI, "");
            return (0, classconBatchCleanup_1.subscriptionIdFromFeatures)(features.body?.features, "classconorderconfirmations");
        },
        loadBadges: async (subscriptionId) => (await (0, getOrderConfirmationBadges_1.getOrderConfirmationBadges)(BASE_URI, "", subscriptionId)).body?.tasksIndex ?? [],
        deleteBadge: async (subscriptionId, badge) => {
            await (0, deleteOrderConfirmationBadge_1.deleteOrderConfirmationBadge)(BASE_URI, "", subscriptionId, badge.batchTask.taskId);
        },
        reClassifyBadge: async (badge) => {
            await (0, ReClassifyItem_1.reClassifyItem)(BASE_URI, {
...
window.OrderConfirmationCleanupFormBundle = __webpack_exports__;
/******/ })()
;
